...
async function getContent() {
    console.log('getContent middleware start')
    let { data:CMS } = await axios.get('http://localhost:1337/pages')
    console.log(CMS)
}
...
//     console.log(app)
//     let menuItems = []
//     let {data} = await app.$axios.get('http://localhost:1337/pages')
    
//     data.forEach(element => {
//         menuItems.push(element.menuTitle)
//     });
